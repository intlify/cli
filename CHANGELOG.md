# v0.13.1 (2023-09-24T13:11:06Z)

This changelog is generated by [GitHub Releases](https://github.com/intlify/cli/releases/tag/v0.13.1)

<!-- Release notes generated using configuration in .github/release.yml at v0.13.1 -->

## What's Changed
### ⚡ Improvement Features
* fix: use `@intlify/utils` in `getLocale` by @kazupon in https://github.com/intlify/cli/pull/68
* fix: drop api-extractor by @kazupon in https://github.com/intlify/cli/pull/69


**Full Changelog**: https://github.com/intlify/cli/compare/v0.13.0...v0.13.1
